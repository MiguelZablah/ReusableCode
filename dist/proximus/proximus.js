...
var proximus = function ($, cookieCtrl) {
	...
	var parse = function parse(val, defaultLngName) {
	...
	var setupEventListeners = function setupEventListeners(ObjectLang, defaultLngName) {
	...
	return {
		...
		changeLng: function changeLng(newLng) {
			replaceUrlParam(proximusObj.cookieName, newLng);
		},

		getProxStrings: function getProxStrings() {
			return proximusObj;
		}
