...
var pager = function (cookie) {
    ...
    return {
        init: function init() {
            ...
            if (catName == null) return "You send categoryName: " + catName + ", and is REQUIERED to run";

            if (totalPages == null) return "You send totalPages: " + totalPages + ", and is REQUIERED to run";
